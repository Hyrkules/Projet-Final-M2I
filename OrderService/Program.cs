...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "CryptoSim - OrderService",
        Version = "v1",
        Description = "Passage et suivi des ordres d'achat/vente"
    });
...
builder.Services.AddScoped<IOrderManagerService, OrderManager>();
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "OrderService V1");
    });
